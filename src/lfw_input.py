...
def read_data(image_paths, label_list, image_size, batch_size, max_nrof_epochs,
              ...
              random_contrast):
    """
    Creates Tensorflow Queue to batch load images.
    Applies transformations to images as they are loaded.
    ...
    for _ in range(num_threads):
        image, label = read_image_from_disk(
            filename_to_label_tuple=input_queue)
